      ...
      <div className="relative">
        ...
        <div className="relative bg-black rounded-[3rem] p-3 shadow-2xl" style={{
          ...
          <div className="relative bg-black rounded-[2.5rem] overflow-hidden h-full" style={{
            ...
            {/* Screen Content */}
            <div className="absolute inset-0 bg-[#121212] overflow-auto" style={{
              scrollbarWidth: 'none',
              ...
              <div className="android-screen-content h-full w-full">
                {children}
              </div>
            </div>
          </div>
          ...
          {/* Power Button */}
          <div className="absolute right-0 top-32 w-1 h-16 bg-slate-800 rounded-l-sm" style={{
            boxShadow: 'inset 1px 0 2px rgba(0, 0, 0, 0.5)'
          }} />
          
          {/* Volume Buttons */}
          <div className="absolute right-0 top-48 space-y-3">
            <div className="w-1 h-12 bg-slate-800 rounded-l-sm" style={{
              boxShadow: 'inset 1px 0 2px rgba(0, 0, 0, 0.5)'
            }} />
            <div className="w-1 h-12 bg-slate-800 rounded-l-sm" style={{
              boxShadow: 'inset 1px 0 2px rgba(0, 0, 0, 0.5)'
